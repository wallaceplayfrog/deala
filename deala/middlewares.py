...
class DealaSpiderMiddleware(object):
...
class DealaDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
    ...
    def process_response(self, request, response, spider):
        ...
        # response: 拦截到的响应对象
        # spider: 爬虫文件中对应的爬虫类 GetfileSpider 的实例对象, 可以通过这个参数拿到 GetfileSpider 中的一些属性或方法
        """
        ...
        if not request.url.endswith('.pdf'):
